...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lmq6qfk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lmq6qfk.containers.anotherwebservice.com/
...
```
git clone git@github.com:davidkonradov-netizen/container-lmq6qfk.git
cd container-lmq6qfk
```
...
```
docker attach container-lmq6qfk
```
